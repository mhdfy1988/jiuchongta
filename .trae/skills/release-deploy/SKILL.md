...
同步更新以下文档，确保与当前代码状态一致：

- **`README.md`** — 特性列表、项目结构、技术栈、Boss/成就/牌型等数量
- **`CHANGELOG.md`** — 本次发布的变更记录（新增/修复/优化/界面/技术），按日期添加新版本条目
- **`docs/GAMEPLAY.md`** — 玩法说明、规则、Boss 效果等如有变动需同步
- **`docs/ARCHITECTURE.md`** — 架构图、模块分层、系统列表如有变动需同步
- **`.trae.md`**（如果存在）— 项目规则和设计决策
