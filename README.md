...
- 11 种牌型，从高牌到五条
- 55 张小丑牌，4 种稀有度（普通 / 稀有 / 史诗 / 传说）
- 16 张塔罗牌 + 9 张星球牌 + 10 张礼券牌
- 卡牌印记系统（金色印记 +3 倍率 / 红色印记出牌后重抽）
- 3 个可解锁角色，各有初始小丑
- 3 种游戏模式（简单 / 困难 / 无尽）
- 22 个 Boss 减益效果（弱 7 / 中 8 / 强 7）
- 20 个成就
- 全局统计面板（总览 / 牌型图鉴 / 游戏行为）
- 计分动画（牌型亮相 → 逐条叠加 → 爆燃结算）
- 本地存档自动保存
...
- **商店**：过关后进入商店，用金币购买小丑牌、塔罗牌、星球牌、礼券牌
